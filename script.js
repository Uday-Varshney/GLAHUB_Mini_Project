...
const music_list = [
  ...
  },
  {
    ...
    music: "music/Pasoori - Shae Gill.mp3",
  },
  {
    img: "img/daku.jpg",
    name: "Daku",
    artist: "	Inderpal Moga",
    music: "music/Daku.mp3",
  },
  {
    img: "img/naam tera.jpg",
    name: "Naam tera",
    artist: "Ndee Kundu, Bamboo Beat",
    music: "music/Naam Tera - Ndee Kundu.mp3",
  },
];
...
searchInput.addEventListener("input", (e) => {
  ...
  music_list.foreach((music_list) => {
    const isVisible =
      music_list.name.includes(value) || music_list.artist.includes(value);
    music_list.element.classList.toggle("hide", !isVisible);
  });
});
